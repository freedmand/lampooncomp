    ...
    return this.each( function() {
        ...
        function toolbar() {
            var tb = $("<div class='rte-toolbar' id='toolbar-"+ element_id +"'><div>\
                <p>\
                    <a href='#' class='bold'><img src='img/bold.png' alt='bold' /></a>\
                    <a href='#' class='italic'><img src='img/italic.png' alt='italic' /></a>\
                    <a href='#' class='underline'><img src='img/underline.png' alt='underline' /></a>\
                </p>\
                </div></div>");
